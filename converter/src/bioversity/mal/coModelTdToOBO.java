...
//	}
	...
	public Frame setConcept(String trait, String id, String def, String categoryId, String crop, String lang, String source) throws FrameMergeException{
		...
		if(source!=null &&(!source.isEmpty() || !source.replaceAll("\"", "").isEmpty())){
			frameTest.addClause(new Clause("xref", source.replaceAll("\"", "")));
		}
...
//		frameTest.addClause(rel);
	...
	public Frame setVariable(String var, String id, String def, String cat, String trait, String method, String scale, String crop, String lang) throws FrameMergeException{
		lang = lang.toLowerCase().replaceAll("\"", "");
		id=id.trim().replaceAll("\"", "");
		var=var.trim().replaceAll("\"", "");
		crop=crop.trim().replaceAll("\"", "");
